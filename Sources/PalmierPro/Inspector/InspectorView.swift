...
struct InspectorView: View {
    ...
    private var availableTabs: [ClipTab] {
        ...
        if aiEditEligible && (ProviderConfig.isConfigured || ProviderConfig.isLocalAIEnabled) { tabs.append(.ai) }
        return tabs
    }
    ...
    private func mediaAssetInspectorContent(_ asset: MediaAsset) -> some View {
        if asset.type.isVisual && (ProviderConfig.isConfigured || ProviderConfig.isLocalAIEnabled) {
            VStack(spacing: 0) {
